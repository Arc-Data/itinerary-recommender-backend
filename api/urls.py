...
urlpatterns = [
    ...
    path('user/business/<int:location_id>/edit/get_foodtag/', get_create_foodtag, name='get_create_foodtag'),
    path('user/business/<int:location_id>/edit/search_foodtag/', search_foodtag, name='search_foodtag'),
