...
urlpatterns = [
    ...
    path('update-ordering/<int:day_id>/', update_ordering, name="update-item-ordering"),
    ...
    path('recommendations/foodplace/', get_foodplace_recommendations, name="get_foodplace_recommendations"),
